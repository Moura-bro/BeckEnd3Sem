...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentarioEvento).HasName("PK__Comentar__4305A1F1CDF01173");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__034EFC04D045B080");
        ...
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__B771C0D889D48C3A");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__50FB6F5DCD5D7471");
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Presencas).HasConstraintName("FK__Presenca__IdUsua__72C60C4A");
        });

        modelBuilder.Entity<TipoEvento>(entity =>
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__CDB3A3BE928FCAB2");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062BCF4D6719");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97F2DC13F8");
