...
CREATE TABLE Usuario(
 ...
 Senha            NVARCHAR(60)       NOT      NULL  UNIQUE             ,  
 
 IdTipoUsuario    UNIQUEIDENTIFIER   
...
CREATE TABLE Evento(
 ...
 FOREIGN KEY REFERENCES TipoEvento(IdTipoEvento),

 IdInstituicao    UNIQUEIDENTIFIER

 FOREIGN KEY REFERENCES Instituicao(IdInstituicao),
);
GO 
...
CREATE TABLE Presenca(
  ...
  FOREIGN KEY REFERENCES Evento(IdEvento),
